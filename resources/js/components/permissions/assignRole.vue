...
export default {
    ...
    data(){
        return {
            ...
            permissions: [],
            defaultPermissions: [
                {resourceName: "Ma\'lumovlar taxtasi",  read: false, write: false, update: false, delete: false, name: '/',         subPage: false, icon:'md-home'},
                {resourceName: "Buyurtmalar",           read: false, write: false, update: false, delete: false, name: '/orders',    subPage: false, icon:'ios-basket'},
                {resourceName: "Maxsulotlar",           read: false, write: false, update: false, delete: false, name: '/products',  subPage: false, icon:'ios-construct'},
                {resourceName: "Xaridorlar",            read: false, write: false, update: false, delete: false, name: '/clients',   subPage: false, icon: 'ios-people'},
                {resourceName: "Foydalanuvchilar",      read: false, write: false, update: false, delete: false, name: '/users',     subPage: false, icon: 'md-people'},
                {resourceName: "Xamkorlar",             read: false, write: false, update: false, delete: false, name: '/partners',  subPage: false, icon: 'ios-appstore'},
                ...
                {resourceName: "Xisobotlar",            read: false, write: false, update: false, delete: false, name: '/reports',   subPage: false, icon: 'md-calculator'},
                {resourceName: "Kartalar",              read: false, write: false, update: false, delete: false, name: '/cards',     subPage: false, icon: 'ios-card'},
                {resourceName: "Sozlamalar",            read: false, write: false, update: false, delete: false, name: '/settings',  subPage: false, icon: 'md-settings'},
            ],
            role: {},
            selected_role_id: 1,
            role_name_err: false,
